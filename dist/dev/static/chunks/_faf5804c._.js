...
"[project]/lib/admission-flow.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "saveAdmissions",
    ()=>saveAdmissions,
    "saveGeneratedCredentials",
    ()=>saveGeneratedCredentials,
    "submitAdmission",
    ()=>submitAdmission
]);
"use client";
const ADMISSION_KEY = "tclass_admissions";
const CREDENTIALS_KEY = "tclass_generated_credentials";
...
function getAdmissions() {
    return readJson(ADMISSION_KEY, []);
}
function saveAdmissions(rows) {
    writeJson(ADMISSION_KEY, rows);
}
function submitAdmission(payload) {
    const rows = getAdmissions();
    const row = {
        ...payload,
...
function getGeneratedCredentials() {
    return readJson(CREDENTIALS_KEY, []);
}
function saveGeneratedCredentials(rows) {
    writeJson(CREDENTIALS_KEY, rows);
}
...
function approveAdmission(id) {
    ...
    saveAdmissions(rows);
    const creds = getGeneratedCredentials();
    const existing = creds.find((c)=>c.admissionId === id);
    if (existing) return existing;
    const created = {
        admissionId: rows[idx].id,
        email: rows[idx].email,
        fullName: rows[idx].fullName,
        studentNumber: generateStudentNumber(),
        tempPassword: generateTempPassword(),
        mustChangePassword: true,
        createdAt: new Date().toISOString()
    };
    creds.unshift(created);
...
function markPasswordChanged(email) {
    const creds = getGeneratedCredentials();
    const next = creds.map((c)=>c.email.toLowerCase() === email.toLowerCase() ? {
            ...c,
            mustChangePassword: false
        } : c);
    saveGeneratedCredentials(next);
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admission$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/admission-flow.ts [app-client] (ecmascript)");
;
...
function AdminDashboard() {
    ...
    const [admissions, setAdmissions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AdminDashboard.useState": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admission$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdmissions"])()
    }["AdminDashboard.useState"]);
    const [activeAdminTab, setActiveAdminTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("users");
    const stats = {
        totalStudents: 1250,
        totalFaculty: 45,
        totalClasses: 85,
    ...
    const generatedCredentials = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admission$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGeneratedCredentials"])();
    const pendingAdmissions = admissions.filter((item)=>item.status === "pending");
    const handleApproveAdmission = (id)=>{
        const generated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admission$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["approveAdmission"])(id);
        if (!generated) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Admission record not found.");
            return;
        }
        setAdmissions((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admission$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdmissions"])());
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Approved. Student No: ${generated.studentNumber} | Temp Password: ${generated.tempPassword}`);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Email queued to ${generated.email} (demo flow).`);
    };
    const handleRejectAdmission = (id)=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admission$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rejectAdmission"])(id);
        setAdmissions((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admission$2d$flow$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdmissions"])());
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Admission rejected.");
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                            className: "hidden sm:inline-flex bg-emerald-100 text-emerald-700 hover:bg-emerald-100",
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                                children: "Verify first-time enrollment requests, then approve or reject."
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/(faculty-admin)/admin/page.tsx",
                                                                lineNumber: 724,
                                                                columnNumber: 21
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                        className: "space-y-6",
                                                        children: [
                                                            pendingAdmissions.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "text-center py-8",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
                                                                        className: "h-12 w-12 text-green-500 mx-auto mb-3"
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        className: "text-slate-600",
                                                                        children: "No pending admissions right now."
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/(faculty-admin)/admin/page.tsx",
                                                                        lineNumber: 730,
                                                                        columnNumber: 25
                                                                ...
                                                                className: "space-y-3",
                                                                children: pendingAdmissions.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        ...
                                                                        children: "Generated Credentials (Demo Email Queue)"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/(faculty-admin)/admin/page.tsx",
                                                                        lineNumber: 759,
                                                                        columnNumber: 23
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "space-y-2",
                                                                        children: [
                                                                            generatedCredentials.slice(0, 5).map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                ...
                                                                                }, item.admissionId, true, {
                                                                                    fileName: "[project]/app/(faculty-admin)/admin/page.tsx",
                                                                                    lineNumber: 762,
                                                                                    columnNumber: 27
                                                                                }, this)),
                                                                            generatedCredentials.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                className: "text-sm text-slate-500",
                                                                                children: "No generated credentials yet."
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/app/(faculty-admin)/admin/page.tsx",
                                                                                lineNumber: 766,
                                                                                columnNumber: 63
...
_s(AdminDashboard, "THcMb4c2KpL+juvtSVDTNupDHlk=");
_c = AdminDashboard;
var _c;
...
//# sourceMappingURL=_faf5804c._.js.map